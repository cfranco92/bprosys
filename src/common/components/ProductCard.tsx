...
export const ProductCard = ({ product }: ProductCardProps) => {
  const { id, name, type, category, interestRate, riskLevel, imageUrl } =
    product;
    ...
    <article>
      ...
      >
        <Card interactive className="h-full">
          <div
            className="relative w-full h-[180px] overflow-hidden bg-gray-100"
          ...
          >
            ...
            {imageError && (
              <div
                className="absolute inset-0 flex items-center justify-center bg-gray-100 text-gray-600 p-4"
                aria-live="polite"
              >
                <div>
