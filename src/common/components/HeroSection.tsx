      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-8 lg:flex-row lg:items-center">
        <div className="flex-1 lg:max-w-[50%]">
          ...
          <p className="text-lg md:text-xl mb-8 opacity-90 leading-relaxed">
            Descubre nuestros productos financieros diseñados para impulsar tus
            metas personales y empresariales con la tecnología más avanzada del
            mercado.
          </p>
          <div className="flex gap-4 flex-wrap">
            <Link
              href="#productos"
              className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white rounded"
            >
              <Button size="large">Ver productos</Button>
            </Link>
            <Link
              href="#contacto"
              className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-white rounded"
        ...
        >
          ...
          {imageLoading && (
            <div
              className="absolute inset-0 flex items-center justify-center bg-blue-800 text-white"
              aria-live="polite"
            >
              <div role="status">
          ...
          {imageError && (
            <div
              className="absolute inset-0 flex items-center justify-center bg-blue-800 text-white text-center p-8"
              aria-live="polite"
            >
              <div>
                <h2 className="text-4xl font-bold mb-4">
                  Tecnología financiera de última generación
                </h2>
