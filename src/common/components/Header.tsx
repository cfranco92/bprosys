  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="flex justify-between items-center p-4 md:p-4 md:px-8 max-w-7xl mx-auto">
        <Link href="/" className="no-underline" aria-label="BProSys - Ir a la página principal">
          <div className="text-2xl font-bold text-[#0056b3] flex items-center gap-2">
            <div className="bg-[#0056b3] text-white w-8 h-8 rounded flex items-center justify-center font-extrabold" aria-hidden="true">
              B
            </div>
            <span>BProSys</span>
          </div>
        ...
        >
          <Link href="/" className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0056b3] rounded">
          ...
          <Link href="/#productos" className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0056b3] rounded">
            <span className="py-3 md:py-0 text-gray-600 font-medium border-b md:border-b-0 border-gray-200 block hover:text-[#0056b3] cursor-pointer">
              Productos
            </span>
          </Link>
          <Link href="/#nosotros" className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0056b3] rounded">
            <span className="py-3 md:py-0 text-gray-600 font-medium border-b md:border-b-0 border-gray-200 block hover:text-[#0056b3] cursor-pointer">
              Nosotros
            </span>
          </Link>
          <Link href="/#contacto" className="no-underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0056b3] rounded">
            <span className="py-3 md:py-0 text-gray-600 font-medium border-b md:border-b-0 border-gray-200 block hover:text-[#0056b3] cursor-pointer">
              Contacto
            </span>
          </Link>
