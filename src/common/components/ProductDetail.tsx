...
export const ProductDetail = ({ product }: ProductDetailProps) => {
  const { name, type, category, description, benefits, imageUrl, performance } =
    product;
    ...
    <main className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
      ...
      <article>
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-600 mb-6">{type}</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <section className="lg:col-span-2">
            ...
            <section aria-labelledby="beneficios-title">
              <h2 id="beneficios-title" className="text-xl font-semibold mb-4">
            ...
            <section aria-labelledby="rendimiento-title">
              <h2 id="rendimiento-title" className="sr-only">
              ...
              {performance && performance.length > 0 ? (
                ...
                <div className="mt-4 p-4 bg-gray-100 rounded-lg">
                  <p className="text-gray-600">
                    Este producto no tiene datos de rendimiento histórico.
                  </p>
                </div>
              )}
            </section>
